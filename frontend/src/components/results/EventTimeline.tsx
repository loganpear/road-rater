  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative h-12 bg-muted rounded-lg overflow-hidden">
        ...
        {/* Event markers */}
        {events.map((event) => {
          const left = (event.timestamp / safeDuration) * 100;
          const width = (event.duration / safeDuration) * 100;
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">{formatDuration(event.timestamp)}</span>
                  </div>
